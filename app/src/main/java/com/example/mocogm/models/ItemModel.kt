...
class ItemListRepo() {
    ...
    val listOfItems: List<ItemModel>? = null // TODO() Liste der Items von der Datenbank returnen. Sind die Items als Liste abfragbar oder müssen wir manuell eine kreieren?
